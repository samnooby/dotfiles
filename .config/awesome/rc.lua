...
--                      title = "HAHA",
--                      text = "Got "..filename.."Put in"..i })
--     end
--     pfile:close()
--     return t
-- end

-- all_backgrounds = scandir("/home/sam/.config/awesome/themes/default/backgrounds")
-- {{{ Error handling
...
tagged_programs = {"code", "firefox", "echo 3", "echo 4", "echo 5", "echo 6", "echo 7", "echo 8", "echo 9",}
